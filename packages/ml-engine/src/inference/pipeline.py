...
from app.schemas.schemas import PredictionRequest  # we can import schemas from backend or define a local fallback
from app.store.useColorStore import Color  # mock fallback helper
...
class MLInferencePipeline:
    ...
    def predict_formulation(self, target_lab: Tuple[float, float, float], bases: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "target_color": {"hex": "#3A86C8", "lab": {"L": target_lab[0], "a": target_lab[1], "b": target_lab[2]}},
            "formulation": {
